...
namespace IR
{
	...
	public:
		UnaryOperation(UnaryOperation&& unary);
	...
	public:
		BinaryOperation(BinaryOperation&& from);
	...
	public:
		...
		triton::uint32 get_high() const
		{
			return this->m_high;
		}
		triton::uint32 get_low() const
		{
			return this->m_low;
		}
