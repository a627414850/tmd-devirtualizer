...
{
	// things need to be set before execution
	triton::uint64 context_addr, lock_addr, bytecode_addr;
	bool execute_jcc;
	...
	// ret / jcc_inside or jmp_inside / jcc_out or jcc_inside
...
public:
	...
	void vmhandler_check_store_access(triton::arch::Instruction& triton_instruction, std::shared_ptr<ThemidaHandlerContext> context);
